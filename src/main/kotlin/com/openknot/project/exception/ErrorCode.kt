...
enum class ErrorCode(
    ...
    // OAuth
    OAUTH_ACCOUNT_MISMATCH(HttpStatus.FORBIDDEN, "OAUTH.001"),
    OAUTH_DUPLICATE_ACCOUNT(HttpStatus.FORBIDDEN, "OAUTH.002"),

    // Generic
    FORBIDDEN(HttpStatus.FORBIDDEN, "GENERIC.001"),
    NOT_FOUND(HttpStatus.NOT_FOUND, "GENERIC.002"),
